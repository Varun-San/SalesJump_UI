...
@Component({
  selector: 'app-general-settings-fs',
  imports: [
    CommonModule,
    FontAwesomeModule,
    MatChipsModule,
  ...
  templateUrl: './general-settings-fs.component.html',
  styleUrl: './general-settings-fs.component.css',
})
export class GeneralSettingsFsComponent {
  Array = Array;
